...
public class NightPath extends Application
{
 //nodes 5, 16, 22, 201, 205, 41, 40, 38, 47, 119, 54, 53
  int[] setX = {122, 195, 261, 325, 390, 455, 455, 453, 565, 715, 717, 835, 835};
  int[] setY = {313, 312, 311, 310, 309, 307, 261, 178, 183, 179, 252, 250, 325};


    @Override public void start(Stage stage)
    {
        // load the image
        Image image = new Image("file:BackgroundDanger.png");
      ...
      //  Circle node203 = new Circle(); //this was repeated

        //nodes 204-207 map N. Newgard St. moving top to bottom
        //top is lower number and bottom is higher numbers
       ...
       // Circle node207 = new Circle(); //this was repeated
       ...
       //Ashland & North Shore
        ...
        node208.setCenterX(320); //Greenview and Pratt
        node208.setCenterY(45);
        node208.setRadius(5);
        root.getChildren().add(node208);

        node209.setCenterX(384); //Newgard and Pratt
        ...
        Path path = new Path();
        path.setStroke(Color.SPRINGGREEN);
        ...
        path.getElements().add(new LineTo(setX[10], setY[10]));
        path.getElements().add(new LineTo(setX[11], setY[11]));
        path.getElements().add(new LineTo(setX[12], setY[12]));
        ...
        pathTransition.setDuration(Duration.seconds(11.0));
